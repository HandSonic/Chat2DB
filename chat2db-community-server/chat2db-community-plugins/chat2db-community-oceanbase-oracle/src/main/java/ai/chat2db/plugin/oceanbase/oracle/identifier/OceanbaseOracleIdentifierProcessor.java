...
/**
 * OceanBase (Oracle mode) dialect identifier processor: double-quoted identifiers
 * with embedded-quote doubling, and single-quote doubling for string literals.
 * Shared stateless instance available via {@link #INSTANCE} for call sites without
 * MetaData access.
 */
public class OceanbaseOracleIdentifierProcessor extends DefaultSQLIdentifierProcessor {
